...
async def get_reviews_by_exhibition(exhibition_id: str, entire_project: bool = False):
    return review_repository.get_reviews_by_exhibition(exhibition_id, entire_project)
